...
class RandomSingleMultiViewCameraIterableDataset(IterableDataset, Updateable):
    def __init__(
        self, cfg_single_view: Any, cfg_multi_view: Any, prob_multi_view: int = None
    ) -> None:
        super().__init__()
        ...
        self.cfg_multi = parse_structured(
            RandomMultiviewCameraDataModuleConfig, cfg_multi_view
        )
...
class SingleMultiviewCombinedCameraDataModule(pl.LightningDataModule):
    ...
    def __init__(self, cfg: Optional[Union[dict, DictConfig]] = None) -> None:
        ...
        self.cfg = cfg
        self.cfg_multi = parse_structured(
            RandomMultiviewCameraDataModuleConfig, cfg.multi_view
        )
        self.cfg_single = parse_structured(
    ...
    def setup(self, stage=None) -> None:
        if stage in [None, "fit"]:
            self.train_dataset = RandomSingleMultiViewCameraIterableDataset(
                self.cfg_single,
                self.cfg_multi,
